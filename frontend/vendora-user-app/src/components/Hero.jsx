...
export default function Hero() {
  ...
  function handleSelect(value) {
    setQuery(value);
    navigate(`/providers?search=${encodeURIComponent(value)}`);
  }
      ...
      <div className="uc-hero__inner">
        ...
        <div className="uc-hero__text">
          ...
          <div className={`uc-hero__searchbox${focused ? ' uc-hero__searchbox--focused' : ''}`}>
            ...
            <svg className="uc-searchbox__icon" width="20" height="20" viewBox="0 0 24 24">
            ...
            <button className="uc-searchbox__btn" onClick={handleSearch}>
              Search
            </button>
            ...
            {focused && query.length > 0 && filtered.length > 0 && (
              <div className="uc-searchbox__dropdown">
                {filtered.map((s) => (
                  <button
                    key={s}
                    className="uc-searchbox__suggestion"
                    onClick={() => handleSelect(s)}
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24">
                      <circle cx="11" cy="11" r="8" stroke="#999" strokeWidth="2" fill="none"/>
