...
public class ProviderController {
    ...
    public ProviderResponse getUserId(@PathVariable String userId){
    ...
    public List<ProviderResponse> getByDistrictAndCategory(@PathVariable District district, @PathVariable ServiceCategory category){
        return providerFacade.getByDistrictAndCategory(district,category);
    }

    @GetMapping("/top-rated/{district}")
    public List<ProviderResponse> getTopRated(@PathVariable District district,@PathVariable ServiceCategory category){
    ...
    @PutMapping("/{id}")
    public ProviderResponse update(@PathVariable String id, @RequestBody UpdateProviderRequest request){
        return providerFacade.updateProvider(id,request);
    }

    @PatchMapping ("/{id}/status")
    public ProviderResponse updateStatus(@PathVariable String id, @RequestParam ProviderStatus status){
    ...
    public ProviderResponse uploadPhoto(@PathVariable String id,@RequestParam("file") MultipartFile file){
    ...
    public ProviderResponse uploadPortfolio(@PathVariable String id,@RequestParam("file") MultipartFile file){
        return providerFacade.uploadPortfolioImage(id,file);
    }

    @DeleteMapping("/{id}/portfolio")
    public ProviderResponse removePortfolio(@PathVariable String id,@RequestParam String imageUrl){
        return providerFacade.removePortfolioImage(id,imageUrl);
    }

    @PatchMapping("/{id}/rating")
    public void updateRating(@PathVariable String id,@RequestParam double rating){
